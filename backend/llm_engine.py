...
DEFAULT_MODEL_PATH = os.path.join(_PROJECT_ROOT, "model", DEFAULT_MODEL_FILE)
...
def _resolve_light_model_path():
    ...
    """Prefer app path; fall back to bundled download path (model/*.gguf)."""
...
def benchmark_inference(
    ...
    Returns a dict suitable for REPORT.md and benchmark.py output.
